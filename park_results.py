...
class ParkResults:
    ...
    def convert_tuple(tup):
        ...
        for i in range(len(tup)):
            ...
            if (isinstance(tup[i], str) or isinstance(tup[i], int) or isinstance(tup[i], bool)):
                string += str(tup[i])
            else:
                string += 'No Data'
        return string
    ...
    def param_constructor(cls, park_info_df, campground_results_df, parking_lot_results_df):
        ...
        for park_row in park_info_df.iterrows():
            ...
            cls.results_string += '{}\n{}\n{}\n\n{}\n{}\n{}\n{}\n\n{}\n\n{}\n\n{}\n\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n{}\n' \
                                  '{}\n{}\n{}\n{}\n{}\n{}\n{}\n\n\n'.format(cls.park, cls.state, cls.amenities,
                    cls.campname, cls.roads, cls.camptype, cls.campADA, cls.wheelchair, cls.rvinfo, cls.campdesc,
                    cls.cellreception, cls.campstore, cls.internet, cls.water, cls.toilet, cls.electricity,
                    cls.staffvolunteer, cls.lotname, cls.adainfo, cls.adaaccess, cls.oversizedspaces, cls.adaspaces,
